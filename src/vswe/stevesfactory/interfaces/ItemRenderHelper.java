...
public class ItemRenderHelper {
    ...
    public static void renderItemIntoGUI(RenderItem renderItem, TextureManager textureManager, ItemStack item, int x, int y) {
        ...
        if (item.getItemSpriteNumber() == 0 && block != null && RenderBlocks.renderItemIn3d(Block.blocksList[k].getRenderType())) {
            ...
            i1 = Item.itemsList[k].getColorFromItemStack(item, 0);
            ...
            for (int j1 = 0; j1 < Item.itemsList[k].getRenderPasses(l); ++j1)
            {
                ...
                Icon icon = Item.itemsList[k].getIcon(item, j1);
                int k1 = Item.itemsList[k].getColorFromItemStack(item, j1);
            ...
            renderItem.renderIcon(x, y, (Icon)object, 16, 16);
            GL11.glEnable(GL11.GL_LIGHTING);
